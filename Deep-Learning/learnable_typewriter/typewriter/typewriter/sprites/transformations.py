...
from learnable_typewriter.typewriter.typewriter.sprites.transformation_module import IdentityModule, ColorModule, PositionModule, TPSModule, MorphologicalModule
